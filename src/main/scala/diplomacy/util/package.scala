...
import org.chipsalliance.diplomacy.util.WideCounter
...
package object util {
  ...
  def HeterogeneousBag[T <: Data](elts: Seq[T]) = org.chipsalliance.diplomacy.nodes.HeterogeneousBag[T](elts)
  @deprecated("HeterogeneousBag has been absorbed into standalone diplomacy library", "rocketchip 2.0.0")
  val HeterogeneousBag = org.chipsalliance.diplomacy.nodes.HeterogeneousBag
}